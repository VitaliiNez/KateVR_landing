...
var _techSpecs = require("./modules/tech-specs");
var _iframeFn = require("./modules/iframeFn");
var _asides = require("./modules/asides");
var _scrollTop = require("./modules/scrollTop");
"use strict";
document.addEventListener("DOMContentLoaded", ()=>{
    (0, _header.burgerFunctionality)();
    (0, _header.stickyHeader)();
    (0, _sliders.sliders)();
    (0, _techSpecs.techSpecs)();
    (0, _iframeFn.iframeFn)();
    (0, _asides.asides)("header__link--help", "popup-help", "popup-help__close-btn", "popup-help--open");
    (0, _asides.asides)("hero-bottom__link--help", "popup-help", "popup-help__close-btn", "popup-help--open");
    (0, _asides.asides)("header__link--language", "language-body", "language-body__close", "language-body--open");
    (0, _scrollTop.scrollTop)("form__top");
});

},{"./modules/header":"bgPfP","./modules/sliders":"fTe7f","./modules/tech-specs":"3vpvG","./modules/iframeFn":"4nPbX","./modules/asides":"7s9Db","./modules/scrollTop":"5ItZf"}],"bgPfP":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "burgerFunctionality", ()=>burgerFunctionality);
...
const burgerFunctionality = ()=>{
    ...
    if (burger_btn && header_menu) burger_btn.addEventListener("click", ()=>{
        burger_btn.classList.toggle("header-burger__btn--open");
        bodyElem.classList.toggle("page__bodyMenu--lock");
...
const stickyHeader = ()=>{
    ...
    window.addEventListener("scroll", function() {
        ...
        if (scrollpos >= 27) add_class_on_scroll();
...
},{}],"fTe7f":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
const sliders = ()=>{
    ...
    const slides = document.querySelectorAll(".about-slider__swiper--desktop .swiper-slide");
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"3vpvG":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "techSpecs", ()=>techSpecs);
const techSpecs = ()=>{
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"4nPbX":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "iframeFn", ()=>iframeFn);
const iframeFn = ()=>{
    ...
    opensButtonPopup.forEach((openBtn)=>{
        openBtn.addEventListener("click", ()=>{
            if (!bodyElem.classList.contains("page__body--lock")) bodyElem.classList.add("page__body--lock");
            popup.classList.add("popup--shown");
            iframe.src = "https://www.youtube.com/embed/Cl_eHeom-RI?si=eheZvOS9j3TfBt70?rel=0?autoplay=1";
        });
    });
    closePopup.addEventListener("click", ()=>{
        if (bodyElem.classList.contains("page__body--lock")) bodyElem.classList.remove("page__body--lock");
        popup.classList.remove("popup--shown");
        iframe.src = "";
    });
};

},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"7s9Db":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "asides", ()=>asides);
const asides = (switcherRef, bodyRef, closeButtonRef, classOnOpenRef)=>{
    ...
    closeBtn.addEventListener("click", ()=>{
        if (bodyElem.classList.contains("page__body--lock")) bodyElem.classList.remove("page__body--lock");
        if (contentBody.classList.contains(classOnOpenRef)) contentBody.classList.remove(classOnOpenRef);
    });
};

},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"5ItZf":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "scrollTop", ()=>scrollTop);
const scrollTop = (nodeTarget)=>{
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["l1XHo","3cYfC"], "3cYfC", "parcelRequire4cc0")
